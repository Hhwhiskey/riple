...
/**
    ...
    //Remove Drop card from the current list
   */
/* public void removeDropFromView(int position) {
        TrickleTabFragment.trickleTabInteractionList.remove(position);
        notifyItemRemoved(position);
        notifyItemRangeChanged(position, TrickleTabFragment.trickleTabInteractionList.size());
...
//        });
    ...
    //DropViewHolder//////////////////////////////////////////////////////////////////////////////
    public class DropViewHolder extends AnimateViewHolder implements View.OnClickListener {
        ...
        @Override
        public void onClick(View v) {
            removeDropCard(getAdapterPosition());
        }

        private void removeDropCard(int position){
            TrickleTabFragment.trickleTabInteractionList.remove(position);
            notifyItemRemoved(position);
        }
