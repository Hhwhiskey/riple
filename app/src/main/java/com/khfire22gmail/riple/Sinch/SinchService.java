...
public class SinchService extends Service {
    ...
    private static final String APP_SECRET  = Resources.getSystem().getString(R.string.SINCH_APP_SECRET);
    private static final String ENVIRONMENT = Resources.getSystem().getString(R.string.SINCH_ENVIRONMENT_HOST);
